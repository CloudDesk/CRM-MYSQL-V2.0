...
function Preview() {
  ...
  const urlimage = `${appConfig.server}/images`
  ...
  useEffect(() => {
    ...
    // axios(`${appConfig.server}/preview-file?searchId=63bcfcae2ed8f352d497fe31 `, {
    //     method: "POST",
    //     responseType: "blob"
    ...
    // fetch(`${appConfig.server}/preview-file?searchId=63bcfcae2ed8f352d497fe31`,{
    //     method: 'POST'
    //   })
