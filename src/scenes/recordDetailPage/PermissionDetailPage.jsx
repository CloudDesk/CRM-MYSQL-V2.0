...
const PermissiionSetForm = ({ item }) => {
  ...
  //   const permissionRecord = location.state?.record?.item ?? {};
  //   setsinglePermission(permissionRecord);
  //   setshowNew(!location.state.record.item);

  //   fetchTableNames();
  //   fetchPermissions();

  //   // If editing an existing record and department exists
  //   if (!showNew && permissionRecord.department) {
  //     FetchRolesbyName(permissionRecord.department, null);
  //   }
  // }, []);
      ...
      .then((res) => {
        if (res.success) {
          ...
          const tableName = res.data.map((i) => {
            return (
              i.Tables_in_crm.charAt(0).toUpperCase() + i.Tables_in_crm.slice(1)
            );
          });
  ...
  console.log(PermissionSetInitialValues, "PermissionSetInitialValues");
  const initialValues = PermissionSetInitialValues;
  console.log(initialValues, "initialValues");
  useEffect(() => {
    if (objTableName.length > 0) {
      ...
      console.log(initialValues, "initialValues after table names loaded");
    }
  }, [objTableName]);
  console.log(initialValues, "initialValues after change");
  ...
  console.log(roleRecordsByDept, "roleRecordsByDept");

  return (
    <Grid item xs={12} style={{ margin: "20px" }}>
      <div style={{ textAlign: "center", marginBottom: "10px" }}>
        {showNew ? (
          <h3>New Permission Set</h3>
        ) : (
          <h3>Permission Set Detail Page </h3>
        )}
      </div>
      <div>
        <Formik
              ...
              <>
                ...
                <Form className="my-form">
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={6} md={6}>
                      <label htmlFor="roledetails">Roles</label>
                      <Field
                        name="roledetails"
                        component={CustomizedSelectForFormik}
                    ...
                    <Grid item xs={12} md={12}>
                      <Accordion>
                        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                          <Typography variant="h4" className="accordion-Header">
                            Permission Sets
                          </Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                          <FieldArray name="permissionsets">
                            {({ remove, push }) => (
                              <>
                                {Array.isArray(values.permissionsets) &&
                                        ...
                                        >
                                          ...
                                          <Grid item xs={8} md={8}>
                                            ...
                                            >
                                              <Grid item xs={3} md={3}>
                                                <label
                                                  htmlFor={`permissionsets.${index}.permissions.read`}
                                                ...
                                                <Field
                                                  ...
                                                  onChange={(e) => {
                                                    if (e.target.checked) {
                                                      ...
                                                      setFieldValue(
                                                        `permissionsets.${index}.permissions.read`,
                                                        e.target.checked
                                                      );
                                                    } else {
                                                      console.log(
                                                      ...
                                                      setFieldValue(
                                                        `permissionsets.${index}.permissions.edit`,
                                                        e.target.checked
                                                      );
                                                      setFieldValue(
                                              ...
                                              <Grid item xs={3} md={3}>
                                                <label
                                                  htmlFor={`permissionsets.${index}.permissions.create`}
                                                  className="checkbox-label"
                                                >
                                                  Create
                                                </label>
                                              ...
                                              <Grid item xs={3} md={3}>
                                                <label
                                                  htmlFor={`permissionsets.${index}.permissions.edit`}
                                                  className="checkbox-label"
                                                >
                                                  Edit
                                                </label>
                                              ...
                                              <Grid item xs={3} md={3}>
                                                <label
                                                  htmlFor={`permissionsets.${index}.permissions.delete`}
                                                  className="checkbox-label"
                                                >
                                                  Delete
                                                </label>
