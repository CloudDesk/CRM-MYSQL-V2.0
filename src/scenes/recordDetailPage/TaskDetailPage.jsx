                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} md={6}>
                                        ...
                                        <Autocomplete
                                            ...
                                            value={
                                                (() => {
                                                    console.log(values.accountdetails, "values.accountdetails")
                                                    console.log(values.opportunitydetails, "values.opportunitydetails");
                                                    ...
                                                    return matchedOption || values.leaddetails || values.opportunitydetails || values.accountdetails || null;
                                                })()

                                            }
                                            getOptionLabel={option => option.leadname || option.accountname || option.opportunityname || ''}
                                            isOptionEqualToValue={(option, value) => {
                                                console.log(option.id === value?.leaddetails?.id, "*******")
                                                if (values.object === 'Enquiry') {
